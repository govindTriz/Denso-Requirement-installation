...
\restrict D98OsLlzEyk6AN9E70ga7Aro25CGcXHWAZl2jjUqXJcnbK7SHEHCsmSdW2EVddT
...
ALTER TABLE ONLY public.zones
    ADD CONSTRAINT "FK_15d4269069700ff13ce40dd11e1" FOREIGN KEY (deployment_id) REFERENCES public.deployments(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.deployments
    ADD CONSTRAINT "FK_5778065f357e6901b3776c37a7f" FOREIGN KEY (plant_id) REFERENCES public.plants(id) ON DELETE CASCADE;
...
\unrestrict D98OsLlzEyk6AN9E70ga7Aro25CGcXHWAZl2jjUqXJcnbK7SHEHCsmSdW2EVddT
