...
\restrict xXoyHd1t4EQxQJTXUyayewUdKjXqgEGwh8cNW9alP4aJpK1NAkUvBNYmjqVusDX
...
--
-- Name: alerts_severity_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.alerts_severity_enum OWNER TO postgres;

--
-- Name: alerts_triggertype_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.alerts_triggertype_enum OWNER TO postgres;

--
-- Name: triggered_alerts_status_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.triggered_alerts_status_enum OWNER TO postgres;
...
--
-- Name: alert_conditions; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: alert_triggers; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.alert_triggers OWNER TO postgres;
...
--
-- Name: triggered_alerts; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.triggered_alerts OWNER TO postgres;
...
--
-- Name: triggered_alerts PK_1c1dcfae594fa1c57725efff389; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: alert_conditions PK_280a963fa1fb3293cff994dcc6a; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: alert_triggers PK_8a7ba06f20359a3ed5a86f5c3fc; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: triggered_alerts FK_4d2599477c8b9a22dfe410f27a6; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: alert_conditions FK_85580af3e70a1323e52afeda39f; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: alert_triggers FK_a55489709c7989bbaa3df3243a9; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict xXoyHd1t4EQxQJTXUyayewUdKjXqgEGwh8cNW9alP4aJpK1NAkUvBNYmjqVusDX
